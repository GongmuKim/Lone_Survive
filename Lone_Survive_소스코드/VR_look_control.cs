...
public class VR_look_control : MonoBehaviour
{
    [HideInInspector]
    ...
    */
     ...
     */
    void CameraFocusMovement()
    {

        //wantedYRotation += Input.GetAxis("Mouse X") * mouseSensitvity;
        wantedYRotation += myCamera.transform.position.x * mouseSensitvity;

        wantedCameraXRotation -= myCamera.transform.position.y * mouseSensitvity;
